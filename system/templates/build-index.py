...
OBJECTS = [
    ("C0-headings.html", "C0 標題 H1／H2／H3【小區塊｜標題】", "小 題"),
    ...
    ("C18-pills.html", "C18 膠囊家族【小區塊～中區塊】", "小 中"),
    ("C19-fork.html", "C19 岔路家族【半頁～全頁】", "半 全"),
    ("C20-spectrum.html", "C20 光譜條【備用｜小區塊】", "小"),
    ("C21-dual.html", "C21 同詞雙義卡【備用｜中區塊～半頁】", "中 半"),
    ("C22-note.html", "C22 對話邊註【備用｜小區塊】", "小"),
    ("C23-cycle.html", "C23 循環圖【中區塊～半頁】", "中 半"),
    ("C24-slot.html", "C24 圖位【小區塊～全頁】", "小 中 半 全"),
    ("C25-bigstat.html", "C25 超大數字【中區塊～半頁】", "中 半"),
    ("C26-term.html", "C26 中英名詞標【小區塊｜標題】", "小 題"),
    ("C26b-reveal.html", "C26b 外文揭曉【中區塊｜標題】", "中 題"),
    ("C27-venn.html", "C27 三圓交疊圖【中區塊～半頁】", "中 半"),
]
